...
public class PhotoGalleryFragment extends VisibleFragment {
    ...
    public void onDestroy() {
        super.onDestroy();
        // It's critical. If you do not quit your HandlerThreads, they will never die
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_item_toggle_polling:
                ...
                getActivity().invalidateOptionsMenu(); // tell activity update toolbar
                return true;
    ...
    private class PhotoAdapter extends RecyclerView.Adapter<PhotoHolder> {
        ...
        public void onBindViewHolder(PhotoHolder photoHolder, int position) {
            ...
            // place downloaded image to holder, one by one
    ...
    // AsyncTask does not create a thread for each instance of  AsyncTask.
    // Instead, it uses something called an Executor to run background work for all AsyncTasks
    // on a single background thread. That means that AsyncTasks will run one after the other.
    // A long running AsyncTask will hog the thread, preventing other AsyncTasks from getting any CPU time
